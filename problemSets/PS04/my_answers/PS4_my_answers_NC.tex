...
\textbf{	\item [(c)] Interpret the coefficient for the constant term substantively.}
	...
	This is the intercept, which is the predicted value Y value when both the variable for lawn sign (D1) = 0, and adjacent lawn sign (D2) = 0. 
...
\textbf{	\item [(d)] Evaluate the model fit for this regression.  What does this	tell us about the importance of yard signs versus other factors that are not modeled?}
 ...
 This tells us that the model could benefit from including other variables alongside yard signs (e.g. maybe variables such as income etc).
